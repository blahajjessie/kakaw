...
export default function Home() {
	...
	const mobileContent = (
		<main className="w-full h-screen bg-purple-100 flex flex-col items-center justify-center font-extrabold">
			<div className="w-4/5 h-full flex flex-col items-center justify-center">
				...
				<div className="w-full h-2/3 bg-purple-500 p-14 -mt-6 rounded-xl overflow-y-auto z-10">
					{entriesList}
				</div>
			</div>
		</main>
	...
	const desktopContent = (
		<main className="w-full h-screen bg-purple-100 flex flex-col items-center justify-center font-extrabold">
			<button className="absolute top-4 right-4 bg-purple-50 self-end px-8 py-2 rounded-lg text-xl text-white shadow-heavy hover:brightness-110">
				Continue
			</button>
			<div className="w-4/5 h-full flex flex-col items-center justify-center">
				<Image alt="logo2" src={logo2} width={150} className="-mb-6" />
